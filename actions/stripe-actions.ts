import { updateCustomerByStripeCustomerIdAction, updateCustomerByUserIdAction } from "@/actions/customers-actions";
...
export const updateStripeCustomer = async (userId: string, subscriptionId: string, customerId: string) => {
  try {
    ...
    const result = await updateCustomerByUserIdAction(userId, {
